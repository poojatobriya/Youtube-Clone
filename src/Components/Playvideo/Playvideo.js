...
const Playvideo = ({videoId}) => {
 ...
 const fetchVideoData = async () => {
  ...
  const fetchotherData = async () => {
    ...
    const videoChannelUrl = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&id=${apiData.snippet.channelId}&key=${API_KEY}`;
  ...
  return (
    <div className='play-video'>
      ...
      <div className='play-video-info'>
        ...
        <div>
            <span><img src={Like} alt=""/>{apiData?apiData.statistics.likeCount:"125"}</span>
        ...
        <div>
            <p>{apiData?apiData.snippet.channelTile:"stack"}</p>
           ...
           <p>{apiData?apiData.snippet.description.slice(0,250):"video description here"}</p>
            ...
            {commentData.map((item, index)=>{
                 return(
                    ...
                    <img src={item.snippet.topLevelComment.snippet.authorProfileImagrUrl} alt=""/>
                    <div>
